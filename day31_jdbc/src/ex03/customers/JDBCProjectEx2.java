...
import Singelton_CRUD.ConnectionSingletonHelper;
...
public class JDBCProjectEx2 extends JFrame implements ActionListener{
	...
	public JDBCProjectEx2(){  // 생성자함수 - 멤버들 초기화 
		//component 등록
	...
	private String sqlDelete ="DELETE FROM COUSTOMERS WHERE NAEM = ?";
...
//			pstmtTotal = conn.prepareCall(sqlTotal, resultSetType, resultSetConcurrency);
			pstmtTotalScroll = conn.prepareCall(sqlTotal, 
					ResultSet.TYPE_SCROLL_SENSITIVE, //커서 이동을 자요롭게하고 업데이트 내용을 반영 한다.
					ResultSet.CONCUR_UPDATABLE);//resultset object의 변경이 가능  <=> CONCUR_READ_ON
...
//			}
			...
			switch (JOptionPane.showConfirmDialog(null, 
					"("+strNo + ","+ strName +","+strMail+","+ strPhone+")",",추가하시겠습니까?",JOptionPane.YES_NO_CANCEL_OPTION)){
			case 0: //확인
				break;
			case 1: //아니오
				return;
